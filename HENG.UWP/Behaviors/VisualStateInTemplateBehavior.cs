...
namespace HENG.UWP.Behaviors
{
    //public class VisualStateInTemplateBehaviorbak : Behavior<UserControl>
    //{
    //    private TaskCompletionSource<bool> _userControlLoaded = new TaskCompletionSource<bool>();
    ...
    //    {
    //        get { return (VisualState)GetValue(NarrowStateProperty); }
    //        set { SetValue(NarrowStateProperty, value); }
    //    }
    //    // Using a DependencyProperty as the backing store for NarrowState.  This enables animation, styling, binding, etc...
    //    public static readonly DependencyProperty NarrowStateProperty =
    //        DependencyProperty.Register("NarrowState", typeof(VisualState), typeof(VisualStateInTemplateBehavior), new PropertyMetadata(null));

    //    public VisualState NormalState
    //    {
    //        get { return (VisualState)GetValue(NormalStateProperty); }
    ...
    //        DependencyProperty.Register("NormalState", typeof(VisualState), typeof(VisualStateInTemplateBehavior), new PropertyMetadata(null));

    //    public VisualState WideState
    //    {
    //        get { return (VisualState)GetValue(WideStateProperty); }
    //        set { SetValue(WideStateProperty, value); }
    //    }
    //    // Using a DependencyProperty as the backing store for WideState.  This enables animation, styling, binding, etc...
    //    public static readonly DependencyProperty WideStateProperty =
    //        DependencyProperty.Register("WideState", typeof(VisualState), typeof(VisualStateInTemplateBehavior), new PropertyMetadata(null));

    //    public VisualStateGroup ParentVisualStateGroup
    //    {
    //        get { return (VisualStateGroup)GetValue(ParentVisualStateGroupProperty); }
    //        set { SetValue(ParentVisualStateGroupProperty, value); }
    //    }
    //    // Using a DependencyProperty as the backing store for ParentVisualStateGroup.  This enables animation, styling, binding, etc...
    //    public static readonly DependencyProperty ParentVisualStateGroupProperty =
    //        DependencyProperty.Register("ParentVisualStateGroup", typeof(VisualStateGroup), typeof(VisualStateInTemplateBehavior), new PropertyMetadata(null, OnParentStateGroupChanged));
    ...
    //    private void OnCurrentStateChanged(object sender, VisualStateChangedEventArgs e) => GoToCorrenspondingState(e.NewState.Name);
    ...
    //    private void OnAssociatedObjectLoaded(object sender, RoutedEventArgs e) => _userControlLoaded.SetResult(true);
    //}
