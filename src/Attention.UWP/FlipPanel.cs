...
namespace Attention.UWP
{
    ...
    public sealed class FlipPanel : Control
    {
        ...
        public static readonly DependencyProperty IsFlippedProperty =
            DependencyProperty.Register("IsFlipped", typeof(bool), typeof(FlipPanel), new PropertyMetadata(false, (s, a) =>
            {
                if (a.NewValue != a.OldValue)
                {
                    if (s is FlipPanel sender)
                    {
        ...
        public static readonly DependencyProperty Side1Property =
            DependencyProperty.Register("Side1", typeof(object), typeof(FlipPanel), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty Side2Property =
            DependencyProperty.Register("Side2", typeof(object), typeof(FlipPanel), new PropertyMetadata(null));
